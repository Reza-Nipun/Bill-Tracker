                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="details" name="details" placeholder="Enter Details" value="{{ old('details') }}"></textarea>
                                </div>
                                <!-- /.form-group -->
                            </div>
                            <!-- /.col -->
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="tr_remarks" name="tr_remarks" placeholder="Enter TR Remarks" value="{{ old('tr_remarks') }}"></textarea>
                                </div>
                                <!-- /.form-group -->
                            </div>
                            <!-- /.col -->
